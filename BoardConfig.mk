...
#TARGET_KERNEL_SOURCE := kernel/bbkedu/H7000
...
TARGET_PREBUILT_KERNEL := device/bbkedu/H7000/prebuilt/kernel.gz
...
TW_DEVICE_VERSION := $(shell date -u +"%Y%m%d"-"Stable"-"Samuioto")
